<?php
/* Kadaverkomplex: siehe http://wp-events-plugin.com/documentation/using-template-files/ */
...
if( user_can($bp->displayed_user->id,'edit_events') ){
	?>
	<div class="uk-panel uk-panel-box">
	<h4 class="uk-panel-title"><?php _e('My Events', 'dbem'); ?></h4>
	<?php
	$args = array(
...
?>
<div class="uk-panel uk-panel-box">
<h4 class="uk-panel-title"><?php _e("Events I'm Attending", 'dbem'); ?></h4>
<?php
