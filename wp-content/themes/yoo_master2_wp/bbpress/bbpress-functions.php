...
'freshness_author_after'     => '</div>'
		...
		if ( !empty( $sub_forums ) ) {
			...
			foreach ( $sub_forums as $sub_forum ) {
				...
				$output .= "<div class='{$class}'><div>" . $link_before . '<div class="bbp-forum-title-container"><a href="' . $permalink . '" class="bbp-forum-link">' . $title . '</a>' . $description . '</div>' . $counts . $freshness_link . $link_after . "</div></div>";
			}
